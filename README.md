...
<div class="content">
  ...
  <!-- Proyecto 2: Bioinformática en Huntington -->
  <button type="button" class="collapsible">
    <div class="project-title">
  ...
  <!-- Proyecto 3: Genética en Leishmania -->
  <button type="button" class="collapsible">
    <div class="project-title">
...
<script>
  ...
  // Ocultar elementos en inglés al cargar
  window.onload = () => {
